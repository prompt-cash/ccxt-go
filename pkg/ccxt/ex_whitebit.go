...
func (this *Whitebit) FetchMarkets(goArgs ...*Variant) *Variant {
	...
	_ = params
	response := this.Call(MkString("publicV2GetMarkets"), params)
	_ = response
	...
	for i := MkInteger(0); IsTrue(OpLw(i, markets.Length)); OpIncr(&i) {
		...
		_ = id
		baseId := this.SafeString(market, MkString("stock"))
		_ = baseId
		quoteId := this.SafeString(market, MkString("money"))
		_ = quoteId
		...
		_ = symbol
		active := this.SafeValue(market, MkString("tradesEnabled"))
		_ = active
		entry := MkMap(&VarMap{
			"id":      id,
			"symbol":  symbol,
...
func (this *Whitebit) FetchCurrencies(goArgs ...*Variant) *Variant {
	params := GoGetArg(goArgs, 0, MkMap(&VarMap{}))
	_ = params
	response := this.Call(MkString("publicV2GetAssets"), params)
	_ = response
	...
	for i := MkInteger(0); IsTrue(OpLw(i, ids.Length)); OpIncr(&i) {
		...
		_ = currency
		canDeposit := this.SafeValue(currency, MkString("canDeposit"), MkBool(true))
		_ = canDeposit
		canWithdraw := this.SafeValue(currency, MkString("canWithdraw"), MkBool(true))
		_ = canWithdraw
...
func (this *Whitebit) FetchTradingFees(goArgs ...*Variant) *Variant {
	params := GoGetArg(goArgs, 0, MkMap(&VarMap{}))
	_ = params
	response := this.Call(MkString("publicV2GetFee"), params)
	_ = response
	fees := this.SafeValue(response, MkString("result"))
	_ = fees
	return MkMap(&VarMap{
...
func (this *Whitebit) FetchTicker(goArgs ...*Variant) *Variant {
	...
	_ = request
	response := this.Call(MkString("publicV1GetTicker"), this.Extend(request, params))
	_ = response
	ticker := this.SafeValue(response, MkString("result"), MkMap(&VarMap{}))
	_ = ticker
...
func (this *Whitebit) ParseTicker(goArgs ...*Variant) *Variant {
	...
	_ = market
	timestamp := this.SafeTimestamp(ticker, MkString("at"), this.Milliseconds())
	_ = timestamp
...
func (this *Whitebit) FetchTickers(goArgs ...*Variant) *Variant {
	...
	_ = params
	this.LoadMarkets()
	response := this.Call(MkString("publicV1GetTickers"), params)
	_ = response
	data := this.SafeValue(response, MkString("result"))
	_ = data
	...
	for i := MkInteger(0); IsTrue(OpLw(i, marketIds.Length)); OpIncr(&i) {
		...
		_ = market
		ticker := this.ParseTicker(*(data).At(marketId), market)
		_ = ticker
...
func (this *Whitebit) FetchOrderBook(goArgs ...*Variant) *Variant {
	...
	response := this.Call(MkString("publicV2GetDepthMarket"), this.Extend(request, params))
	_ = response
	result := this.SafeValue(response, MkString("result"), MkMap(&VarMap{}))
	_ = result
	timestamp := this.Parse8601(this.SafeString(result, MkString("lastUpdateTimestamp")))
	_ = timestamp
...
func (this *Whitebit) FetchTradesV1(goArgs ...*Variant) *Variant {
	...
	response := this.Call(MkString("publicV1GetHistory"), this.Extend(request, params))
	_ = response
...
func (this *Whitebit) FetchTradesV2(goArgs ...*Variant) *Variant {
	...
	response := this.Call(MkString("publicV2GetTradesMarket"), this.Extend(request, params))
	_ = response
	result := this.SafeValue(response, MkString("result"), MkArray(&VarArray{}))
	_ = result
	return this.ParseTrades(result, market, since, limit)
...
func (this *Whitebit) FetchTrades(goArgs ...*Variant) *Variant {
	...
	params := GoGetArg(goArgs, 3, MkMap(&VarMap{}))
	_ = params
	method := this.SafeString(*this.At(MkString("options")), MkString("fetchTradesMethod"), MkString("fetchTradesV2"))
	_ = method
...
func (this *Whitebit) ParseTrade(goArgs ...*Variant) *Variant {
	...
	market := GoGetArg(goArgs, 1, MkUndefined())
	_ = market
	timestamp := this.SafeValue(trade, MkString("time"))
	_ = timestamp
	...
	_ = priceString
	amountString := this.SafeString2(trade, MkString("amount"), MkString("volume"))
	_ = amountString
	...
	if IsTrue(OpEq2(side, MkUndefined())) {
		isBuyerMaker := this.SafeValue(trade, MkString("isBuyerMaker"))
		_ = isBuyerMaker
...
func (this *Whitebit) FetchOHLCV(goArgs ...*Variant) *Variant {
	...
	if IsTrue(OpNotEq2(since, MkUndefined())) {
		...
		_ = duration
		end := this.Sum(start, OpMulti(duration, limit))
		_ = end
	...
	response := this.Call(MkString("publicV1GetKline"), this.Extend(request, params))
	_ = response
	result := this.SafeValue(response, MkString("result"), MkArray(&VarArray{}))
	_ = result
...
func (this *Whitebit) FetchStatus(goArgs ...*Variant) *Variant {
	params := GoGetArg(goArgs, 0, MkMap(&VarMap{}))
	_ = params
	response := this.Call(MkString("webGetV1Healthcheck"), params)
	_ = response
	status := this.SafeInteger(response, MkString("status"))
	_ = status
	formattedStatus := MkString("ok")
	_ = formattedStatus
...
func (this *Whitebit) Sign(goArgs ...*Variant) *Variant {
	...
	_ = path
	api := GoGetArg(goArgs, 1, MkString("publicV1"))
	_ = api
