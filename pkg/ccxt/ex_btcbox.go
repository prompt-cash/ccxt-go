...
func (this *Btcbox) FetchBalance(goArgs ...*Variant) *Variant{
  ...
  for i := MkInteger(0) ; IsTrue(OpLw(i , codes.Length )); OpIncr(& i ){
    ...
    free := OpAdd(currencyId , MkString("_balance") ); _ = free;
    if IsTrue(OpHasMember(free , response )) {
      account := this.Account(); _ = account;
      used := OpAdd(currencyId , MkString("_lock") ); _ = used;
...
func (this *Btcbox) FetchOrderBook(goArgs ...*Variant) *Variant{
  ...
  numSymbols := OpCopy((*((this).At(MkString("symbols")))).Length ); _ = numSymbols;
...
func (this *Btcbox) FetchTrades(goArgs ...*Variant) *Variant{
  ...
  response := this.Call(MkString("publicGetOrders"), this.Extend(request , params )); _ = response;
...
func (this *Btcbox) CreateOrder(goArgs ...*Variant) *Variant{
  ...
  response := this.Call(MkString("privatePostTradeAdd"), this.Extend(request , params )); _ = response;
...
func (this *Btcbox) CancelOrder(goArgs ...*Variant) *Variant{
  ...
  response := this.Call(MkString("privatePostTradeCancel"), this.Extend(request , params )); _ = response;
  return this.ParseOrder(response , market );
}
...
func (this *Btcbox) ParseOrder(goArgs ...*Variant) *Variant{
  ...
  datetimeString := this.SafeString(order , MkString("datetime") ); _ = datetimeString;
...
func (this *Btcbox) FetchOrder(goArgs ...*Variant) *Variant{
  ...
  response := this.Call(MkString("privatePostTradeView"), this.Extend(request , params )); _ = response;
  return this.ParseOrder(response , market );
}
...
func (this *Btcbox) FetchOrdersByType(goArgs ...*Variant) *Variant{
  ...
  response := this.Call(MkString("privatePostTradeList"), this.Extend(request , params )); _ = response;
...
func (this *Btcbox) Sign(goArgs ...*Variant) *Variant{
  ...
  if IsTrue(OpEq2(api , MkString("public") )) {
    ...
    request := this.Urlencode(query ); _ = request;
...
func (this *Btcbox) HandleErrors(goArgs ...*Variant) *Variant{
  ...
  code := this.SafeValue(response , MkString("code") ); _ = code;
