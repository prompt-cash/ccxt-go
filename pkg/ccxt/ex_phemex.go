...
func (this *Phemex) ParseSwapMarket(goArgs ...*Variant) *Variant {
	...
	_ = id
	baseId := this.SafeString2(market, MkString("baseCurrency"), MkString("contractUnderlyingAssets"))
	_ = baseId
	...
	_ = symbol
	type_ := this.SafeStringLower(market, MkString("type"))
	_ = type_
	...
	_ = precision
	priceScale := this.SafeInteger(market, MkString("priceScale"))
	_ = priceScale
	ratioScale := this.SafeInteger(market, MkString("ratioScale"))
	_ = ratioScale
	valueScale := this.SafeInteger(market, MkString("valueScale"))
	_ = valueScale
	minPriceEp := this.SafeString(market, MkString("minPriceEp"))
	_ = minPriceEp
	maxPriceEp := this.SafeString(market, MkString("maxPriceEp"))
	_ = maxPriceEp
	makerFeeRateEr := this.SafeString(market, MkString("makerFeeRateEr"))
	_ = makerFeeRateEr
	takerFeeRateEr := this.SafeString(market, MkString("takerFeeRateEr"))
	_ = takerFeeRateEr
	...
	_ = status
	active := OpEq2(status, MkString("Listed"))
	_ = active
	return MkMap(&VarMap{
		"id":         id,
		"symbol":     symbol,
...
func (this *Phemex) ParseSpotMarket(goArgs ...*Variant) *Variant {
	...
	_ = swap
	taker := this.SafeNumber(market, MkString("defaultTakerFee"))
	_ = taker
	maker := this.SafeNumber(market, MkString("defaultMakerFee"))
	_ = maker
	precision := MkMap(&VarMap{
...
func (this *Phemex) FetchMarkets(goArgs ...*Variant) *Variant {
	...
	_ = params
	v2Products := this.Call(MkString("publicGetCfgV2Products"), params)
	_ = v2Products
	v1Products := this.Call(MkString("v1GetExchangePublicProducts"), params)
	_ = v1Products
	v1ProductsData := this.SafeValue(v1Products, MkString("data"), MkArray(&VarArray{}))
	_ = v1ProductsData
	v2ProductsData := this.SafeValue(v2Products, MkString("data"), MkMap(&VarMap{}))
	_ = v2ProductsData
	products := this.SafeValue(v2ProductsData, MkString("products"), MkArray(&VarArray{}))
	_ = products
	riskLimits := this.SafeValue(v2ProductsData, MkString("riskLimits"), MkArray(&VarArray{}))
	_ = riskLimits
	riskLimitsById := this.IndexBy(riskLimits, MkString("symbol"))
	_ = riskLimitsById
	v1ProductsById := this.IndexBy(v1ProductsData, MkString("symbol"))
	_ = v1ProductsById
	result := MkArray(&VarArray{})
	_ = result
	for i := MkInteger(0); IsTrue(OpLw(i, products.Length)); OpIncr(&i) {
		market := *(products).At(i)
		_ = market
		type_ := this.SafeStringLower(market, MkString("type"))
		_ = type_
		if IsTrue(OpEq2(type_, MkString("perpetual"))) {
			id := this.SafeString(market, MkString("symbol"))
			_ = id
			riskLimitValues := this.SafeValue(riskLimitsById, id, MkMap(&VarMap{}))
			_ = riskLimitValues
			market = this.Extend(market, riskLimitValues)
			v1ProductsValues := this.SafeValue(v1ProductsById, id, MkMap(&VarMap{}))
			_ = v1ProductsValues
...
func (this *Phemex) FetchCurrencies(goArgs ...*Variant) *Variant {
	params := GoGetArg(goArgs, 0, MkMap(&VarMap{}))
	_ = params
	response := this.Call(MkString("publicGetCfgV2Products"), params)
	_ = response
	...
	for i := MkInteger(0); IsTrue(OpLw(i, currencies.Length)); OpIncr(&i) {
		...
		_ = code
		valueScaleString := this.SafeString(currency, MkString("valueScale"))
		_ = valueScaleString
		valueScale := parseInt(valueScaleString)
		_ = valueScale
		minValueEv := this.SafeString(currency, MkString("minValueEv"))
		_ = minValueEv
		maxValueEv := this.SafeString(currency, MkString("maxValueEv"))
		_ = maxValueEv
		...
		if IsTrue(OpNotEq2(valueScale, MkUndefined())) {
			precisionString := this.ParsePrecision(valueScaleString)
			_ = precisionString
...
func (this *Phemex) ParseBidAsk(goArgs ...*Variant) *Variant {
	...
	amount := this.SafeString(bidask, amountKey)
	_ = amount
...
func (this *Phemex) FetchOrderBook(goArgs ...*Variant) *Variant {
	...
	_ = request
	response := this.Call(MkString("v1GetMdOrderbook"), this.Extend(request, params))
	_ = response
	result := this.SafeValue(response, MkString("result"), MkMap(&VarMap{}))
	_ = result
	book := this.SafeValue(result, MkString("book"), MkMap(&VarMap{}))
	_ = book
	timestamp := this.SafeIntegerProduct(result, MkString("timestamp"), MkNumber(0.000001))
	_ = timestamp
	orderbook := this.ParseOrderBook(book, symbol, timestamp, MkString("bids"), MkString("asks"), MkInteger(0), MkInteger(1), market)
	_ = orderbook
...
func (this *Phemex) ToEn(goArgs ...*Variant) *Variant {
	n := GoGetArg(goArgs, 0, MkUndefined())
	_ = n
...
func (this *Phemex) ToEp(goArgs ...*Variant) *Variant {
	price := GoGetArg(goArgs, 0, MkUndefined())
	_ = price
	market := GoGetArg(goArgs, 1, MkUndefined())
	_ = market
...
func (this *Phemex) FromEn(goArgs ...*Variant) *Variant {
	en := GoGetArg(goArgs, 0, MkUndefined())
	_ = en
	scale := GoGetArg(goArgs, 1, MkUndefined())
	_ = scale
...
func (this *Phemex) FromEp(goArgs ...*Variant) *Variant {
	ep := GoGetArg(goArgs, 0, MkUndefined())
	_ = ep
	market := GoGetArg(goArgs, 1, MkUndefined())
	_ = market
...
func (this *Phemex) FromEv(goArgs ...*Variant) *Variant {
	ev := GoGetArg(goArgs, 0, MkUndefined())
	_ = ev
	market := GoGetArg(goArgs, 1, MkUndefined())
	_ = market
...
func (this *Phemex) FromEr(goArgs ...*Variant) *Variant {
	er := GoGetArg(goArgs, 0, MkUndefined())
	_ = er
	market := GoGetArg(goArgs, 1, MkUndefined())
	_ = market
...
func (this *Phemex) FetchOHLCV(goArgs ...*Variant) *Variant {
	...
	_ = params
	request := MkMap(&VarMap{"resolution": *(*this.At(MkString("timeframes"))).At(timeframe)})
	_ = request
	...
	*(request).At(MkString("symbol")) = *(market).At(MkString("id"))
	response := this.Call(MkString("publicGetMdKline"), this.Extend(request, params))
	_ = response
	data := this.SafeValue(response, MkString("data"), MkMap(&VarMap{}))
	_ = data
	rows := this.SafeValue(data, MkString("rows"), MkArray(&VarArray{}))
	_ = rows
...
func (this *Phemex) ParseTicker(goArgs ...*Variant) *Variant {
	...
	_ = symbol
	timestamp := this.SafeIntegerProduct(ticker, MkString("timestamp"), MkNumber(0.000001))
	_ = timestamp
	lastString := this.FromEp(this.SafeString(ticker, MkString("lastEp")), market)
	_ = lastString
	last := this.ParseNumber(lastString)
	_ = last
	quoteVolume := this.ParseNumber(this.FromEv(this.SafeString(ticker, MkString("turnoverEv")), market))
	_ = quoteVolume
	...
	_ = average
	openString := this.FromEp(this.SafeString(ticker, MkString("openEp")), market)
	_ = openString
	open := this.ParseNumber(openString)
	_ = open
...
func (this *Phemex) FetchTicker(goArgs ...*Variant) *Variant {
	...
	request := MkMap(&VarMap{"symbol": *(market).At(MkString("id"))})
	_ = request
	method := OpTrinary(*(market).At(MkString("spot")), MkString("v1GetMdSpotTicker24hr"), MkString("v1GetMdTicker24hr"))
	_ = method
...
func (this *Phemex) FetchTrades(goArgs ...*Variant) *Variant {
	...
	request := MkMap(&VarMap{"symbol": *(market).At(MkString("id"))})
	_ = request
	response := this.Call(MkString("v1GetMdTrade"), this.Extend(request, params))
	_ = response
	result := this.SafeValue(response, MkString("result"), MkMap(&VarMap{}))
	_ = result
...
func (this *Phemex) ParseTrade(goArgs ...*Variant) *Variant {
	...
	if IsTrue(GoIsArray(trade)) {
		...
		execStatus := this.SafeString(trade, MkString("execStatus"))
		_ = execStatus
		...
		feeCostString := this.FromEv(this.SafeString(trade, MkString("execFeeEv")), market)
		_ = feeCostString
		if IsTrue(OpNotEq2(feeCostString, MkUndefined())) {
			feeRateString := this.FromEr(this.SafeString(trade, MkString("feeRateEr")), market)
			_ = feeRateString
			...
			if IsTrue(*(market).At(MkString("spot"))) {
				...
				info := this.SafeValue(market, MkString("info"))
				_ = info
				if IsTrue(OpNotEq2(info, MkUndefined())) {
					settlementCurrencyId := this.SafeString(info, MkString("settlementCurrency"))
					_ = settlementCurrencyId
...
func (this *Phemex) ParseSpotBalance(goArgs ...*Variant) *Variant {
	...
	for i := MkInteger(0); IsTrue(OpLw(i, data.Length)); OpIncr(&i) {
		...
		_ = code
		currency := this.SafeValue(*this.At(MkString("currencies")), code, MkMap(&VarMap{}))
		_ = currency
		scale := this.SafeInteger(currency, MkString("valueScale"), MkInteger(8))
		_ = scale
		account := this.Account()
		_ = account
		balanceEv := this.SafeString(balance, MkString("balanceEv"))
		_ = balanceEv
		lockedTradingBalanceEv := this.SafeString(balance, MkString("lockedTradingBalanceEv"))
		_ = lockedTradingBalanceEv
		lockedWithdrawEv := this.SafeString(balance, MkString("lockedWithdrawEv"))
		_ = lockedWithdrawEv
		total := this.FromEn(balanceEv, scale)
		_ = total
		lockedTradingBalance := this.FromEn(lockedTradingBalanceEv, scale)
		_ = lockedTradingBalance
		lockedWithdraw := this.FromEn(lockedWithdrawEv, scale)
		_ = lockedWithdraw
		used := Precise.StringAdd(lockedTradingBalance, lockedWithdraw)
		_ = used
		lastUpdateTimeNs := this.SafeIntegerProduct(balance, MkString("lastUpdateTimeNs"), MkNumber(0.000001))
		_ = lastUpdateTimeNs
...
func (this *Phemex) ParseSwapBalance(goArgs ...*Variant) *Variant {
	...
	data := this.SafeValue(response, MkString("data"), MkMap(&VarMap{}))
	_ = data
	balance := this.SafeValue(data, MkString("account"), MkMap(&VarMap{}))
	_ = balance
	currencyId := this.SafeString(balance, MkString("currency"))
	_ = currencyId
	code := this.SafeCurrencyCode(currencyId)
	...
	account := this.Account()
	_ = account
	accountBalanceEv := this.SafeString(balance, MkString("accountBalanceEv"))
	_ = accountBalanceEv
	totalUsedBalanceEv := this.SafeString(balance, MkString("totalUsedBalanceEv"))
	_ = totalUsedBalanceEv
	valueScale := this.SafeInteger(currency, MkString("valueScale"), MkInteger(8))
	_ = valueScale
...
func (this *Phemex) FetchBalance(goArgs ...*Variant) *Variant {
	...
	_ = params
	this.LoadMarkets()
	defaultType := this.SafeString2(*this.At(MkString("options")), MkString("defaultType"), MkString("fetchBalance"), MkString("spot"))
	_ = defaultType
	type_ := this.SafeString(params, MkString("type"), defaultType)
	_ = type_
	method := MkString("privateGetSpotWallets")
	_ = method
	...
	if IsTrue(OpEq2(type_, MkString("swap"))) {
		...
		if IsTrue(OpNotEq2(code, MkUndefined())) {
			...
			*(request).At(MkString("currency")) = *(currency).At(MkString("id"))
			...
			currency := this.SafeString(params, MkString("currency"))
			_ = currency
	...
	response := this.Call(method, this.Extend(request, params))
	_ = response
	result := OpTrinary(OpEq2(type_, MkString("swap")), this.ParseSwapBalance(response), this.ParseSpotBalance(response))
	_ = result
	return result
}
...
func (this *Phemex) ParseSpotOrder(goArgs ...*Variant) *Variant {
	...
	_ = symbol
	price := this.ParseNumber(this.OmitZero(this.FromEp(this.SafeString(order, MkString("priceEp")), market)))
	_ = price
	amount := this.ParseNumber(this.OmitZero(this.FromEv(this.SafeString(order, MkString("baseQtyEv")), market)))
	_ = amount
	remaining := this.ParseNumber(this.OmitZero(this.FromEv(this.SafeString(order, MkString("leavesBaseQtyEv")), market)))
	_ = remaining
	filled := this.ParseNumber(this.OmitZero(this.FromEv(this.SafeString(order, MkString("cumBaseQtyEv")), market)))
	_ = filled
	cost := this.ParseNumber(this.OmitZero(this.FromEv(this.SafeString(order, MkString("quoteQtyEv")), market)))
	_ = cost
	average := this.ParseNumber(this.OmitZero(this.FromEp(this.SafeString(order, MkString("avgPriceEp")), market)))
	_ = average
	...
	_ = type_
	timestamp := this.SafeIntegerProduct2(order, MkString("actionTimeNs"), MkString("createTimeNs"), MkNumber(0.000001))
	_ = timestamp
	fee := OpCopy(MkUndefined())
	_ = fee
	feeCost := this.ParseNumber(this.FromEv(this.SafeString(order, MkString("cumFeeEv")), market))
	_ = feeCost
	...
	_ = timeInForce
	stopPrice := this.ParseNumber(this.OmitZero(this.FromEp(this.SafeString(order, MkString("stopPxEp"), market))))
	_ = stopPrice
...
func (this *Phemex) ParseSwapOrder(goArgs ...*Variant) *Variant {
	...
	_ = type_
	price := this.ParseNumber(this.FromEp(this.SafeString(order, MkString("priceEp")), market))
	_ = price
	...
	_ = remaining
	timestamp := this.SafeIntegerProduct(order, MkString("actionTimeNs"), MkNumber(0.000001))
	_ = timestamp
	cost := this.SafeNumber(order, MkString("cumValue"))
	_ = cost
	lastTradeTimestamp := this.SafeIntegerProduct(order, MkString("transactTimeNs"), MkNumber(0.000001))
	...
	timeInForce := this.ParseTimeInForce(this.SafeString(order, MkString("timeInForce")))
	_ = timeInForce
	stopPrice := this.SafeNumber(order, MkString("stopPx"))
	_ = stopPrice
	postOnly := OpEq2(timeInForce, MkString("PO"))
	_ = postOnly
	return MkMap(&VarMap{
...
func (this *Phemex) CreateOrder(goArgs ...*Variant) *Variant {
	...
	_ = request
	if IsTrue(*(market).At(MkString("spot"))) {
		qtyType := this.SafeValue(params, MkString("qtyType"), MkString("ByBase"))
		_ = qtyType
	...
	stopPrice := this.SafeString2(params, MkString("stopPx"), MkString("stopPrice"))
	_ = stopPrice
	...
	method := OpTrinary(*(market).At(MkString("spot")), MkString("privatePostSpotOrders"), MkString("privatePostOrders"))
	_ = method
	response := this.Call(method, this.Extend(request, params))
	_ = response
	data := this.SafeValue(response, MkString("data"), MkMap(&VarMap{}))
...
func (this *Phemex) CancelOrder(goArgs ...*Variant) *Variant {
	...
	request := MkMap(&VarMap{"symbol": *(market).At(MkString("id"))})
	_ = request
	clientOrderId := this.SafeString2(params, MkString("clientOrderId"), MkString("clOrdID"))
	_ = clientOrderId
	params = this.Omit(params, MkArray(&VarArray{
	...
	method := OpTrinary(*(market).At(MkString("spot")), MkString("privateDeleteSpotOrders"), MkString("privateDeleteOrdersCancel"))
	_ = method
	response := this.Call(method, this.Extend(request, params))
	_ = response
	data := this.SafeValue(response, MkString("data"), MkMap(&VarMap{}))
...
func (this *Phemex) FetchOrder(goArgs ...*Variant) *Variant {
	...
	market := this.Market(symbol)
	_ = market
	method := OpTrinary(*(market).At(MkString("spot")), MkString("privateGetSpotOrdersActive"), MkString("privateGetExchangeOrder"))
	_ = method
	request := MkMap(&VarMap{"symbol": *(market).At(MkString("id"))})
	_ = request
	clientOrderId := this.SafeString2(params, MkString("clientOrderId"), MkString("clOrdID"))
...
func (this *Phemex) FetchOrders(goArgs ...*Variant) *Variant {
	...
	market := this.Market(symbol)
	_ = market
	method := OpTrinary(*(market).At(MkString("spot")), MkString("privateGetSpotOrders"), MkString("privateGetExchangeOrderList"))
	_ = method
	request := MkMap(&VarMap{"symbol": *(market).At(MkString("id"))})
	_ = request
	if IsTrue(OpNotEq2(since, MkUndefined())) {
...
func (this *Phemex) FetchOpenOrders(goArgs ...*Variant) *Variant {
	...
	market := this.Market(symbol)
	_ = market
	method := OpTrinary(*(market).At(MkString("spot")), MkString("privateGetSpotOrders"), MkString("privateGetOrdersActiveList"))
	_ = method
	request := MkMap(&VarMap{"symbol": *(market).At(MkString("id"))})
	_ = request
...
func (this *Phemex) FetchClosedOrders(goArgs ...*Variant) *Variant {
	...
	market := this.Market(symbol)
	_ = market
	method := OpTrinary(*(market).At(MkString("spot")), MkString("privateGetExchangeSpotOrder"), MkString("privateGetExchangeOrderList"))
	_ = method
	request := MkMap(&VarMap{"symbol": *(market).At(MkString("id"))})
	_ = request
	if IsTrue(OpNotEq2(since, MkUndefined())) {
...
func (this *Phemex) FetchMyTrades(goArgs ...*Variant) *Variant {
	...
	market := this.Market(symbol)
	_ = market
	method := OpTrinary(*(market).At(MkString("spot")), MkString("privateGetExchangeSpotOrderTrades"), MkString("privateGetExchangeOrderTrade"))
	_ = method
	request := MkMap(&VarMap{"symbol": *(market).At(MkString("id"))})
	_ = request
	if IsTrue(OpNotEq2(since, MkUndefined())) {
...
func (this *Phemex) FetchDepositAddress(goArgs ...*Variant) *Variant {
	...
	_ = request
	response := this.Call(MkString("privateGetPhemexUserWalletsV2DepositAddress"), this.Extend(request, params))
	_ = response
	data := this.SafeValue(response, MkString("data"), MkMap(&VarMap{}))
	_ = data
...
func (this *Phemex) FetchDeposits(goArgs ...*Variant) *Variant {
	...
	response := this.Call(MkString("privateGetExchangeWalletsDepositList"), params)
	_ = response
	data := this.SafeValue(response, MkString("data"), MkMap(&VarMap{}))
	_ = data
...
func (this *Phemex) FetchWithdrawals(goArgs ...*Variant) *Variant {
	...
	response := this.Call(MkString("privateGetExchangeWalletsWithdrawList"), params)
	_ = response
	data := this.SafeValue(response, MkString("data"), MkMap(&VarMap{}))
	_ = data
	return this.ParseTransactions(data, currency, since, limit)
...
func (this *Phemex) ParseTransaction(goArgs ...*Variant) *Variant {
	...
	_ = code
	timestamp := this.SafeInteger2(transaction, MkString("createdAt"), MkString("submitedAt"))
	_ = timestamp
	type_ := this.SafeStringLower(transaction, MkString("type"))
	_ = type_
	feeCost := this.ParseNumber(this.FromEn(this.SafeString(transaction, MkString("feeEv")), *(currency).At(MkString("valueScale"))))
	_ = feeCost
	fee := OpCopy(MkUndefined())
	_ = fee
	if IsTrue(OpNotEq2(feeCost, MkUndefined())) {
	...
	_ = status
	amount := this.ParseNumber(this.FromEn(this.SafeString(transaction, MkString("amountEv")), *(currency).At(MkString("valueScale"))))
	_ = amount
	return MkMap(&VarMap{
		"info":        transaction,
		"id":          id,
...
func (this *Phemex) FetchPositions(goArgs ...*Variant) *Variant {
	...
	response := this.Call(MkString("privateGetAccountsAccountPositions"), this.Extend(request, params))
	_ = response
	data := this.SafeValue(response, MkString("data"), MkMap(&VarMap{}))
	_ = data
	positions := this.SafeValue(data, MkString("positions"), MkArray(&VarArray{}))
	_ = positions
	return positions
}
...
func (this *Phemex) Sign(goArgs ...*Variant) *Variant {
	...
	_ = query
	requestPath := OpAdd(MkString("/"), this.ImplodeParams(path, params))
	_ = requestPath
	url := OpCopy(requestPath)
	_ = url
	...
	if IsTrue(OpEq2(api, MkString("private"))) {
		...
		_ = timestamp
		xPhemexRequestExpiry := this.SafeInteger(*this.At(MkString("options")), MkString("x-phemex-request-expiry"), MkInteger(60))
		_ = xPhemexRequestExpiry
		...
		auth := OpAdd(requestPath, OpAdd(queryString, OpAdd(expiryString, payload)))
		_ = auth
...
func (this *Phemex) HandleErrors(goArgs ...*Variant) *Variant {
	...
	error := this.SafeValue(response, MkString("error"), response)
	_ = error
	errorCode := this.SafeString(error, MkString("code"))
	_ = errorCode
	message := this.SafeString(error, MkString("msg"))
	_ = message
